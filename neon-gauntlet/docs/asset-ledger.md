...
| `switchblade-sora-sheet` | `public/assets/sprites/bosses/switchblade-sora-sheet.png` | Imported/generated boss sheet candidate | Blocked | Cleaned and cropped from project-provided high-resolution sheet. Contact sheets generated under `docs/contact-sheets/bosses/switchblade-sora/`. Needs human visual approval and licensing approval before release. |
...
| `harbor-hale-sheet` | `public/assets/sprites/bosses/harbor-hale-sheet.png` | Prototype-derived temporary boss sheet | Blocked | Temporary split from the previous Sora prototype placeholder so Harbor Hale does not reuse Sora's new art. Replace with hand-authored/approved final Harbor Hale art before release. |
